...
// ---- SHA-1 + Base64 for the handshake -------------------------------------
// Same algorithm as src/hwmon/http_server.cpp but lives in an anonymous
// namespace here so the two daemons don't share symbols.
